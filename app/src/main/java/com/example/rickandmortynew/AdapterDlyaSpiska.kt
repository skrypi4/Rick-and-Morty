...
class AdapterDlyaSpiska (val ctx: Context, val resource: Int, val items: ArrayList<Response.CharactersSpisokItems>): ArrayAdapter<Response.CharactersSpisokItems>(ctx, resource, items){
